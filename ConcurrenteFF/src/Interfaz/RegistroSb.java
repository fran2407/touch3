 ...
 * @author Usuario
 */
public class RegistroSb extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Intruccion.setText("Edite su perfil:");
        ...
        JLBcontrasena.setText("Nueva contraseña");
        getContentPane().add(JLBcontrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 370, -1, -1));

        JLBId.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        JLBId.setForeground(new java.awt.Color(102, 0, 102));
        JLBId.setText("Nueva ID");
        getContentPane().add(JLBId, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, -1, -1));
        ...
        JLBsexo.setText("Editar sexo");
        getContentPane().add(JLBsexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, -1, 20));
        ...
        JLBapellidos.setText("Nuevo apellidos");
        getContentPane().add(JLBapellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, -1, -1));
        ...
        JLBcnfcontrasena.setText("Confirma nueva Contrsaseña");
        getContentPane().add(JLBcnfcontrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 410, -1, -1));

        JLBedad.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        JLBedad.setForeground(new java.awt.Color(102, 0, 102));
        JLBedad.setText("Edite edad");
        getContentPane().add(JLBedad, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, -1, -1));
        ...
        JBLCorreo.setText("Nuevo correo");
        getContentPane().add(JBLCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 290, -1, 20));

        labelprecio.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        labelprecio.setText("Precio:");
        getContentPane().add(labelprecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 450, -1, -1));
        getContentPane().add(JTXFcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 290, 140, -1));
        getContentPane().add(Jtxtprecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 450, 220, -1));

        JBLnombre.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        JBLnombre.setForeground(new java.awt.Color(102, 0, 102));
        JBLnombre.setText("Nuevo nombre");
        getContentPane().add(JBLnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (JTXFnombre.getText().isEmpty() || JTXFapellidos.getText().isEmpty() || JCBXsexo.getSelectedItem().toString().isEmpty()
                ...
                || Integer.parseInt(Jtxtprecio.getText()) == 0) {
            ...
            String precio = Jtxtprecio.getText();
            boolean valid = false;
            admin a = new admin();

            Sb newsb = new Sb(precio, nombre, apellido, sexo, email, pass, id, edad);//Se guarda el usuario

            for (int i = 0; i < admin.listaUsSb.size(); i++) {//For para que recorra la lista 
                System.out.println("Entra en el for para verificar");
                if (JTXFid.getText().equals(newsb.id)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroSb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroSb().setVisible(true);
            }
        });
    }
